...
const BLOG_CATEGORY_OPTIONS = [
  { id: "Wedding Music", color: "#E11D48" },
  { id: "Event Planning", color: "#BE123C" },
  { id: "Artist Spotlights", color: "#F43F5E" },
  { id: "Sound & Acoustics", color: "#4C0519" },
  { id: "Heritage Traditions", color: "#BE123C" },
] as const;
...
export function BlogEditorModal({ article, isOpen, onClose, onSave }: BlogEditorModalProps) {
  ...
  useEffect(() => {
    if (article) {
      ...
      setCategoryColor(article.categoryColor || "#E11D48");
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/75 backdrop-blur-md flex items-center justify-center p-3 sm:p-6">
      ...
      <div className="relative w-full max-w-4xl bg-white rounded-3xl shadow-2xl overflow-hidden z-10 my-8 border border-white/40 flex flex-col max-h-[92vh]">
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto px-6 sm:px-8 py-6 space-y-6">
          ...
          <div className="bg-[#FFF8F8] p-5 rounded-2xl border border-[#F3E5E8] space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full text-xs font-body bg-white border border-[#F3E5E8] rounded-xl px-3.5 py-2.5 text-[#1A1A1A] focus:outline-none focus:ring-2 focus:ring-[#E11D48]/30 font-medium"
              />
            </div>
            ...
            <div className="grid sm:grid-cols-4 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full text-xs font-body bg-white border border-[#F3E5E8] rounded-xl px-3 py-2 text-[#1A1A1A] cursor-pointer"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs font-body bg-white border border-[#F3E5E8] rounded-xl px-3 py-2 text-[#1A1A1A]"
                />
              </div>
              ...
              <div className="sm:col-span-2 space-y-3">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-1 text-[10px]">
                      <button
                        ...
                        className={`px-1.5 py-0.5 rounded cursor-pointer ${
                          avatarImageMode === "upload" ? "text-[#E11D48] font-bold underline" : "text-[#5B5B5B]"
                        }`}
                      >
                        Upload
                      </button>
                      ...
                      <button
                        ...
                        className={`px-1.5 py-0.5 rounded cursor-pointer ${
                          avatarImageMode === "url" ? "text-[#E11D48] font-bold underline" : "text-[#5B5B5B]"
                        }`}
                      >
                        URL
                      </button>
                  ...
                  {avatarImageMode === "upload" ? (
                    <div className="flex items-center gap-3 bg-white p-2 border border-[#F3E5E8] rounded-xl">
                      <img
                        src={authorAvatar}
                        alt="Avatar preview"
                      ...
                      <input
                        ...
                        className="text-xs text-[#5B5B5B] file:mr-2 file:py-1 file:px-2.5 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-[#FFF0F3] file:text-[#BE123C] hover:file:bg-[#E11D48] hover:file:text-white cursor-pointer"
                      />
                    </div>
                  ) : (
                    <input
          ...
          <div className="bg-[#FFF8F8] p-5 rounded-2xl border border-[#F3E5E8] space-y-4">
            ...
            <div className="space-y-2">
              {keyTakeaways.map((item, idx) => (
                <div key={idx} className="flex items-center gap-2 bg-white p-2.5 rounded-xl border border-[#F3E5E8]">
                  <span className="text-[#E11D48] font-bold text-sm">✦</span>
                  <input
                    type="text"
          ...
          <div className="bg-[#FFF8F8] p-5 rounded-2xl border border-[#F3E5E8] space-y-4">
            ...
            <div className="space-y-4">
              {sections.map((sec, idx) => (
                <div key={idx} className="bg-white p-4 rounded-2xl border border-[#F3E5E8] space-y-3">
                  <div className="flex items-center justify-between">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-xs font-body border border-[#F3E5E8] rounded-xl px-3 py-2 text-[#1A1A1A]"
                    />
                  </div>
          ...
          <div className="bg-[#FFF8F8] p-5 rounded-2xl border border-[#F3E5E8] space-y-3">
            <h3 className="font-display font-bold text-sm text-[#BE123C] uppercase tracking-wider">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full text-xs font-body bg-white border border-[#F3E5E8] rounded-xl px-3.5 py-2 text-[#1A1A1A] cursor-pointer"
                >
